...
description: "Spot, OHLC, market caps, volume, derivatives, exchanges. 147 tools on a dedicated Hive endpoint."
---
...
147 tools live behind it. The root endpoint reaches the same tools through
