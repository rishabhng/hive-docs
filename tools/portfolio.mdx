...
description: "Wallet balances, history, PnL, approvals across EVM and Solana. 96 tools on a dedicated Hive endpoint."
---
...
96 tools live behind it. The root endpoint reaches the same tools through
