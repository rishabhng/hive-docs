...
description: "TVL, yields, fees, chain breakdowns, stablecoins, tracked hacks. 26 tools on a dedicated Hive endpoint."
---
...
26 tools live behind it. The root endpoint reaches the same tools through
