...
description: "Pool, pair, liquidity, and trade flow data across major EVM and Solana markets. 46 tools on a dedicated Hive endpoint."
---
...
46 tools live behind it. The root endpoint reaches the same tools through
