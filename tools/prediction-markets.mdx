...
description: "Polymarket events, traders, market prices, settlement history. 21 tools on a dedicated Hive endpoint."
---

Polymarket events, traders, market prices, settlement history.
...
21 tools live behind it. The root endpoint reaches the same tools through
