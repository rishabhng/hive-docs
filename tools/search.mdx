...
description: "Cross-provider search across coins, tokens, exchanges, categories, events. 19 tools on a dedicated Hive endpoint."
---
...
19 tools live behind it. The root endpoint reaches the same tools through
