...
<AccordionGroup>
  ...
  <Accordion title="Where does the data come from?">
    15 providers including CoinGecko, Alchemy, DeFiLlama, GoPlus, CCXT, Helius, Polymarket, and
  ...
  <Accordion title="Why does my agent only see eight tools?">
    ...
    discovery, because a 525 tool list would crowd out the conversation and make selection
