...
Hive exposes 546 callable tools. If a client loaded all of them at once, the tool list alone
...
Two reasons. A 546 tool list eats context that should hold the actual problem, and it makes
